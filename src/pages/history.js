        ...
        <Navbar/>
            <div className="filtersDiv">
                ...
                <div className="filterSingle">
                    ...
                    <div className="select"><select name="model_name" value={filters.modelName} onChange={handleChange}>
                ...
                <div className="filterSingle">
                    ...
                    <input type="number" name="min_air_pressure" value={filters.minAirPressure} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Maksimalni vazdušni pritisak:</label>
                    <input type="number" name="max_air_pressure" value={filters.maxAirPressure} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Minimalna vlažnost vazduha:</label>
                    <input type="number" name="min_humidity" value={filters.minHumidity} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Maksimalna vlažnost vazduha:</label>
                    <input type="number" name="max_humidity" value={filters.maxHumidity} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Minimalna temperatura:</label>
                    <input type="number" name="min_temperature" value={filters.minTemperature} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Maksimalna temperatura:</label>
                    <input type="number" name="max_temperature" value={filters.maxTemperature} onChange={handleChange} />
                </div>
                {/*<div className="filterSingle">*/}
                ...
                <div className="filterSingle">
                    ...
                    <input type="number" name="min_particular_matter_25_ranking" value={filters.minParticularMatter25Ranking} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Maksimalni rang PM2.5:</label>
                    <input type="number" name="max_particular_matter_25_ranking" value={filters.maxParticularMatter25Ranking} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Minimalna koncentracija PM2.5:</label>
                    <input type="number" name="min_particular_matter_25_concentration" value={filters.minParticularMatter25Concentration} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Maksimalna koncentracija PM2.5:</label>
                    <input type="number" name="max_particular_matter_25_concentration" value={filters.maxParticularMatter25Concentration} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Minimalna koncentracija PM10:</label>
                    <input type="number" name="min_particular_matter_10_concentration" value={filters.minParticularMatter10Concentration} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Maksimalna koncentracija PM10:</label>
                    <input type="number" min={0} max={50} name="max_particular_matter_10_concentration" value={filters.maxParticularMatter10Concentration} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Minimalni rang PM10:</label>
                    <input type="number" name="min_particular_matter_10_ranking" value={filters.minParticularMatter10Ranking} onChange={handleChange} />
                </div>
                <div className="filterSingle">
                    <label>Maksimalni rang PM10:</label>
                    <input type="number" name="max_particular_matter_10_ranking" value={filters.maxParticularMatter10Ranking} onChange={handleChange} />
                </div>
                    <div className="filterSingle">
            ...
            <div className="dataTableContainer">
                 <DataTableComponent dataTableData={dataTableData} filters={filters}/>
            </div>
            )}
        <Footer/>
        </>
